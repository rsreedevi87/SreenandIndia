class S26{
    ...
    display(){
        ...
        this.title.html("UTTAR PRADESH");
        this.opt1 = createElement('h1.5');
        this.opt1.position(460,150);
        this.opt1.html("UTTAR PRADESH'S CAPITAL IS LUCKNOW");
        ...
        this.opt3.html("ITS AREA IS 243286 km²");
        this.opt4 = createElement('h1.5');
        this.opt4.position(460,450);
        this.opt4.html("ITS POPULATION IS ABOUT 20.42 CRORES");
        this.opt5 = createElement('h1.5');
        this.opt5.position(460,550);
        this.opt5.html("FESTIVAL CELEBRATED IS RAKSHA BANDHAN");
        this.opt6 = createElement('h1.5');
        this.opt6.position(460,650);
        this.opt6.html("KATHAK IS FAMOUS DANCE FORM AT UTTAR PRADESH");
        back.show();
